...
export const LogoMark = ({ size = 36, className }: P) => (
  <svg width={size} height={size} viewBox="0 0 42 42" aria-hidden="true" className={className}>
    <rect x="1.5" y="1.5" width="39" height="39" rx="3" fill="none" stroke="#1F3A44" strokeWidth="2.2" />
    <path d="M9 10h24L9 32h24" fill="none" stroke="#1F3A44" strokeWidth="2.6" strokeLinejoin="round" />
    <path d="M9 15h16M17 27h16" stroke="#A94F33" strokeWidth="2.2" />
  </svg>
);
